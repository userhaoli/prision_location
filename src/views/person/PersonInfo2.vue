      ...
      <div class="left-content">
        <div class="content-controller">
          <!-- <div class="check-item">
            站点：
            <spinner :content="stationArr[stationid]" :list="stationArr" @sendValue="getStation"></spinner>
          </div>-->
          <div class="check-item">
            <spinner
      ...
      <div class="right-content" v-show="flag">
        <div class="person-msgs">
          <div class="msg-head">
            ...
            <!-- <ul
              class="person-data"
              style="line-height: 22px;margin-top:15px;padding-left:10px;padding-top: 10px"
            >-->
            <!-- <li>姓名：{{personData.name}}</li>
              <li>性别：{{personData.sex?"男":"女"}}</li>
            <li>编号：{{personData.polid}}</li>-->
            <!-- <li>部门：{{ personData.dep }}</li> -->
            <!-- <li>职务：{{ personData.job }}</li> -->
            <!-- <li>电话：{{personData.tel}}</li> -->
            <!--<li>籍贯：{{ personData.hometown }}</li>-->
            <!--<li>证件号：{{ personData.cardid }}</li>-->
            <!--<li>居住地址：{{ personData.address }}</li>-->
            <!-- <li>职务：{{personData.type?personData.type.name:""}}</li> -->
            <!-- </ul> -->
          </div>
...
//     background-color: rgba(24, 45, 77, 0.1);
//   }
//   li {
//     // background: 0 !important;
//     border: 1px solid rgba(134, 208, 255, 0.2);
